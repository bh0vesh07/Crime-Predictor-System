...
regresso = pickle.load(open(r'C:\project\crime hotspots\model\murder.pkl','rb'))
sandy = pickle.load(open(r'C:\project\crime hotspots\model\theft.pkl','rb'))
rap = pickle.load(open(r'C:\project\crime hotspots\model\rap.pkl','rb'))
last = pickle.load(open(r'C:\project\crime hotspots\model\total.pkl','rb'))
scaler = MinMaxScaler()
#scaler = MinMaxScaler()
